...
Hey there, welcome back to Words with Clues!
</amazon:emotion>
...
<amazon:emotion name="excited" intensity="medium">
Look who's back for more Words with Clues! 
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
...
<amazon:emotion name="excited" intensity="medium">
Hey <alexa:name type="first" personId="{}"/>, welcome back to Words with Clues! 
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
You've earned a grand total of {} points playing. Nice! Do you need a refresher on the rules of the game?
</amazon:emotion>
...
<amazon:emotion name="excited" intensity="medium">
Look who's back for more Words with Clues it's <alexa:name type="first" personId="{}"/>! 
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
Last time you played you earned {} points. Let's see what you can do this game! Do you need to hear the rules?
</amazon:emotion>
...
<amazon:emotion name="excited" intensity="medium">
Welcome back to Words with Clues <alexa:name type="first" personId="{}"/>! 
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
...
<amazon:emotion name="excited" intensity="medium">
<alexa:name type="first" personId="{}"/> is in the house and ready for more Words with Clues! 
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
...
Woohoo more Words with Clues coming right up!
</amazon:emotion>
<amazon:emotion name="excited" intensity="low">
...
HELP_MESSAGE = """
<prosody rate="90%">
Words with Clues is played in five rounds.
...
FIRST_GAME_MESSAGE = "<amazon:emotion name=\"excited\" intensity=\"high\">" +\
    "Thanks for playing Words with Clues!</amazon:emotion> " + \
    HELP_MESSAGE + \
...
<amazon:emotion name="excited" intensity="medium">
Thanks so much for playing Words with Clues, see you next time!
</amazon:emotion>
"""

EXIT_WITH_REVIEW_REQUEST = """
<amazon:emotion name="excited" intensity="medium">
Thanks for playing Words with Clues!
